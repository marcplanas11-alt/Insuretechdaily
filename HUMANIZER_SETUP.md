...
The humanizer detects and fixes **29 AI writing patterns** based on [Wikipedia's "Signs of AI writing"](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing) guide. The skill also includes a final "obviously AI generated" audit pass and second rewrite to catch lingering AI-isms.
...
- Based on [Wikipedia: Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing) - Primary source
- [WikiProject AI Cleanup](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_AI_Cleanup) - Maintaining organization
- [Humanizer GitHub](https://github.com/blader/humanizer) - Full source code and latest updates
